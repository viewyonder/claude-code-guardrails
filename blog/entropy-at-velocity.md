...
template: https://github.com/injectionator/claude-code-guardrails
---
...
We've extracted the system into a [companion template](https://github.com/injectionator/claude-code-guardrails) that you can adopt in about 15 minutes. It includes:
