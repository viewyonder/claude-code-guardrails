...
4. **Template completeness**: The template directory contains all 11 hooks, 5 agents, and 4 skills (coherence, coherence-setup, check-architecture, test) listed in the SPEC documents. Verified by: file counts match SPEC-HOOKS, SPEC-AGENTS, and SPEC-SKILLS.
